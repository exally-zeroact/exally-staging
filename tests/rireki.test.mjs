...
/* ══ ③一覧 ══ */
const 行たち = [
  { いつ: new Date(2026, 7, 20, 10, 0), 種類: '診断', 見出し: '危ない所 122か所', 中身: { やった: '調べた', 何か所: 122 }, ファイル名: '代行計算表2026.xlsb' },
  { いつ: new Date(2026, 7, 25, 14, 3), 種類: '自動化', 見出し: '税込の列を足した', 中身: { 聞いた: '税込がほしい', やった: '列を足した', 何か所: 31 }, クレジット: 1 },
