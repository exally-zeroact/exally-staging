/**
 * payslip-mint-yoko1.js
 * 給料明細 B横型（ミントデザイン）プレビュー
 * レイアウト: 支給|控除 左右2列 / 複数人縦積み
 * 対応: b_1p〜b_3p
 */
/**
 * payslip-preview.js
...
function renderPayslipPreview(el, layout, ninzu, activeItems) {
  ...
  el.innerHTML = people.map(function(p){ return makeBCard(p, compact, df); }).join(perf);
}
